...
class MovementService:
    ...
    def get_movements(self, process: Process, page_number: int = 1) -> List[Movement]:
    ...
    def __fetch_movements__(
        ...
        response = self.api_client.get(
            f"{self.api_client.config.movements_api_route}{process.number}/{process.cd_doc_process}/{process.cd_instance}/{page_number}/1000"
        )
